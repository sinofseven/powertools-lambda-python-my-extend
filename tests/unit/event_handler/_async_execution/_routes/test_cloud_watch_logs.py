    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                {"log_group": "test-log-group", "log_stream": "test-log-stream", "subscription_filters": ["test"]},
                True,
            ),
            (
                {
                    "func": None,
                    "log_group": "test-log-group-v2",
                    "log_stream": "test-log-stream",
                    "subscription_filters": ["test"],
                },
                {"log_group": "test-log-group", "log_stream": "test-log-stream", "subscription_filters": ["test"]},
            ...
            (
                ...
                {"log_group": "test-log-group", "log_stream": "test-log-stream", "subscription_filters": None},
                True,
            ),
            (
                {
            ...
            (
                {"func": None, "log_group": "test-log-group", "subscription_filters": ["test"]},
                {"log_group": "test-log-group", "log_stream": None, "subscription_filters": ["test"]},
                True,
            ),
            (
                {"func": None, "log_group": "test-log-group-v2", "subscription_filters": ["test"]},
                {"log_group": "test-log-group", "log_stream": None, "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "log_group": "test-log-group", "subscription_filters": ["name"]},
                {"log_group": "test-log-group", "log_stream": None, "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "log_group": "test-log-group-v2", "subscription_filters": ["name"]},
                {"log_group": "test-log-group", "log_stream": None, "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "log_stream": "test-log-stream", "subscription_filters": ["test"]},
                {"log_group": None, "log_stream": "test-log-stream", "subscription_filters": ["test"]},
                True,
            ),
            (
                {"func": None, "log_stream": "test-log-stream-v2", "subscription_filters": ["test"]},
                {"log_group": None, "log_stream": "test-log-stream", "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "log_stream": "test-log-stream", "subscription_filters": ["name"]},
                {"log_group": None, "log_stream": "test-log-stream", "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "log_stream": "test-log-stream-v2", "subscription_filters": ["name"]},
                {"log_group": None, "log_stream": "test-log-stream", "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "log_group": "test-log-group"},
                {"log_group": "test-log-group", "log_stream": None, "subscription_filters": None},
                True,
            ),
            (
                {"func": None, "log_group": "test-log-group-v2"},
                {"log_group": "test-log-group", "log_stream": None, "subscription_filters": None},
                False,
            ),
            (
                {"func": None, "log_stream": "test-log-stream"},
                {"log_group": None, "log_stream": "test-log-stream", "subscription_filters": None},
                True,
            ),
            (
                {"func": None, "log_stream": "test-log-stream-v2"},
                {"log_group": None, "log_stream": "test-log-stream", "subscription_filters": None},
                False,
            ),
            (
                {"func": None, "subscription_filters": ["test"]},
                {"log_group": None, "log_stream": None, "subscription_filters": ["test"]},
                True,
            ),
            (
                {"func": None, "subscription_filters": ["name"]},
                {"log_group": None, "log_stream": None, "subscription_filters": ["test"]},
                False,
            ),
            (
                {"func": None, "subscription_filters": ["name"]},
                {"log_group": None, "log_stream": None, "subscription_filters": None},
                False,
            ),
        ],
    )
    def test_is_target(self, option_constructor, option, expected):
        route = CloudWatchLogsRoute(**option_constructor)
        actual = route.is_target(**option)
        assert actual == expected
