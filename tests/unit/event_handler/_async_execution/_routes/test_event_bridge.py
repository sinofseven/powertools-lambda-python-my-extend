    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {"detail_type": "EC2 Instance State-change Notification", "source": "aws.ec2", "resources": None},
                True,
            ),
            (
                {
            ...
            (
                ...
                {"detail_type": "EC2 Instance State-change Notification", "source": None, "resources": None},
                True,
            ),
            (
                {
            ...
            (
                ...
                {"detail_type": None, "source": "aws.ec2", "resources": None},
                True,
            ),
            (
                {
            ...
            (
                {"func": None, "resources": ["arn:aws:ec2:us-west-1:123456789012:instance/i-9999999999abcdef9"]},
                {
                    "detail_type": None,
                    "source": None,
                    "resources": ["arn:aws:ec2:us-west-1:123456789012:instance/i-1234567890abcdef0"],
            ...
            (
                ...
                {"detail_type": None, "source": None, "resources": None},
                False,
            ),
        ],
    )
